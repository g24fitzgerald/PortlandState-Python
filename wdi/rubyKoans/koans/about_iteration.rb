...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #In the above example the value 0 given to inject is set as the sum, and takes the first item of the array to perform that operation (0+2)
    #the result of the operation becomes the new sum (2) and the operation is performed on the next item (2+3) and the result will be the new sum
    #once all items in the array have been iterated through, the resulting value is returned (9)
  end
