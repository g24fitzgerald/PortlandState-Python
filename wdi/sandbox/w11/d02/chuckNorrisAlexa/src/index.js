 ...
 */
var APP_ID = 'amzn1.ask.skill.90bed2f9-c7fc-40e2-bdc5-47d726bd7166'; //replace with "amzn1.echo-sdk-ams.app.[your-unique-value-here]";
...
AskChuck.prototype.intentHandlers = {
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        response.ask("You can ask for a random chuck Norris fact!", "You can say hello to me!");
    }
};
